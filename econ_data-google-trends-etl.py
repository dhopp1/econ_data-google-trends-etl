...
word_list = ['economy', 'job', 'hiring', 'rent', 'loan', 'tv', 'computer', 'smart phone', 'bankruptcy', 'university', 'school', 'education', 'election']
...
conn_string = "host="+ psql_creds.PGHOST +" port="+ "5432" +" dbname="+ psql_creds.PGDATABASE +" user=" + psql_creds.PGUSER +" password="+ psql_creds.PGPASSWORD
conn = psycopg2.connect(conn_string)

print("Updating database")
engine = create_engine('postgresql://' + psql_creds.PGUSER + ':' + psql_creds.PGPASSWORD + '@' + psql_creds.PGHOST + ':5432/' + psql_creds.PGDATABASE)
